...
Youbora.prototype.videoPlaybackStarted = function(track) {
  ...
  var startProps = {
    ...
    User: track.userId() || this.analytics.user().id(),
...
Youbora.prototype.videoContentPlaying = function(track) {
  ...
  var pingProps = {
    ...
    bitrate: track.proxy('properties.bitrate'),
    totalBytes: youboraOpts.totalBytes,
...
// TODO: Add Video Ad Clicked once its been added to the spec

/**
 * Get Youbora Opts
 * Retrieve Youbora integration specific options into object
 * @param {Facade} Track
 */
