  ...
  if (Array.isArray(players.jwplayer)) {
    this.load('youbora-jwplayer', function() {
      players.jwplayer.forEach(function(playerObj) {
        self.hookPlayer(playerObj.options, new window.youbora.adapters.JWPlayer7(playerObj.player), new window.youbora.adapters.JWPlayer7.GenericAdsAdapter(playerObj.player));
      });
    });
  }
  ...
  if (Array.isArray(players.theplatform)) {
    this.load('youbora-theplatform', function() {
      players.theplatform.forEach(function(playerObj) {
        self.hookPlayer(playerObj.options, new window.youbora.adapters.ThePlatform(playerObj.player), new window.youbora.adapters.ThePlatform.GenericAdsAdapter(playerObj.player));
      });
    });
  }
  if (Array.isArray(players.videojs)) {
    this.load('youbora-videojs', function() {
      players.videojs.forEach(function(playerObj) {
        self.hookPlayer(playerObj.options, new window.youbora.adapters.Videojs5(playerObj.player), new window.youbora.adapters.Videojs5.GenericAdsAdapter(playerObj.player));
      });
    });
  }
};
