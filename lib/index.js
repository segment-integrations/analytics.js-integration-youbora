...
Youbora.prototype.videoPlaybackStarted = function(track) {
  ...
  adsAdapter.getPosition = function() { return data.ad_type; };
    ...
    this.load('youbora-jwplayer', function() {
      players.jwplayer.forEach(function(playerObj) {
        self.hookPlayer(
          ...
          new window.youbora.adapters.JWPlayer7.GenericAdsAdapter(playerObj.player)
        );
      });
    });
  }
    ...
    this.load('youbora-theplatform', function() {
      players.theplatform.forEach(function(playerObj) {
        self.hookPlayer(
          ...
          new window.youbora.adapters.ThePlatform.GenericAdsAdapter(playerObj.player)
        );
      });
    });
  }
    ...
    this.load('youbora-videojs', function() {
      players.videojs.forEach(function(playerObj) {
        self.hookPlayer(
          ...
          new window.youbora.adapters.Videojs5.GenericAdsAdapter(playerObj.player)
        );
      });
    });
  }
